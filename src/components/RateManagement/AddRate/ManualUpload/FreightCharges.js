...
const FreightCharges = ({
    ...
    const handleChange = (id, name, value) => {
        const chargesCopy = [...freightCharges];
        ...
        setFreightCharges(chargesCopy);
    };

    const addCharge = () => {
        setFreightCharges((prevState) => {
            return [
                ...prevState,
                {
                    label: "",
    ...
    return (
        <div className="w-full">
            {!editMode && <p className="text-[22px] font-rocGroteskBold mb-6">Freight charges</p>}
            <div>
