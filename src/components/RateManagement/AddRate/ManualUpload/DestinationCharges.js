...
const DestinationCharges = ({
    ...
    const handleChange = (id, name, value) => {
        const chargesCopy = [...destinationCharges];
        ...
        setDestinationCharges(chargesCopy);
    };

    const addCharge = () => {
        setDestinationCharges((prevState) => {
            return [
                ...prevState,
                {
                    label: "",
    ...
    return (
        <div className="w-full">
            {!editMode && (
                <p className="text-[22px] font-rocGroteskBold mb-6">Destination charges</p>
            )}
            <div>
                {destinationCharges?.map((charge, idx) => {
                    return (
...
export default DestinationCharges;
